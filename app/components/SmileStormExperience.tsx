...
export function SmileStormExperience() {
  ...
  return (
    <main className="experience-shell live-room-shell">
      <section className="live-room" aria-labelledby="hero-title">
        <header className="live-room-nav">
          ...
          <div className="live-nav-actions">
            ...
            <button
              ...
              onClick={isExperienceVisible ? stopExperience : startExperience}
            >
              {isExperienceVisible ? <StopCircle size={18} weight="fill" /> : <VideoCamera size={18} weight="fill" />}
              {isExperienceVisible ? "结束" : "开启直播"}
            </button>
          </div>
        </header>

        <div className="live-room-grid">
          <section className="live-room-center" aria-label="直播舞台">
            <div
              ...
              {!isExperienceVisible && (
                <div className="prelive-preview">
                  ...
                  <div className="prelive-copy">
                    ...
                    <h1 id="hero-title">
                      <span className="hero-title-line">笑一下，</span>
                      <em className="hero-title-line">让天气回应你。</em>
                    </h1>
                    <p>开始体验，让表情、3D 礼物与粒子物理同时进入直播画面。</p>
                    <button className="preview-start-button" onClick={startExperience}>
                      <Play size={18} weight="fill" />开始体验 · 开启直播
                    </button>
                  </div>
                </div>
              )}
            ...
            <footer className="live-room-toolbar" aria-label="直播操作栏">
              <div className="toolbar-group toolbar-primary">
                <button
                  ...
                  onClick={isExperienceVisible ? stopExperience : startExperience}
                  aria-label={isExperienceVisible ? "结束直播" : "开启直播"}
                >
                  {isExperienceVisible ? <StopCircle size={22} weight="fill" /> : <Play size={22} weight="fill" />}
                </button>
          ...
          <aside className="live-room-right" aria-label="直播信息与礼物">
            <section className="live-card live-info-card">
              ...
              <dl>
                <div><dt>直播状态</dt><dd className={isExperienceVisible ? "is-live" : ""}>{isExperienceVisible ? "直播中" : "待开播"}</dd></div>
            ...
            <section className="live-card live-gifts-card">
              ...
              <div className="gift-drop-policy" aria-label="稀有礼物掉落规则">
                <span><b>6%/秒</b> 雨中稀有掉落</span>
                <span><b>18%/次</b> 烟花稀有掉落</span>
                <span><b>1 秒</b> 仅展示 1 秒</span>
              </div>
            </section>
